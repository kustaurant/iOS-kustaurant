...
//  Kustaurant
//
//  Created by peppermint100 on 8/2/24.
//
...
extension UIColor {
    ...
    enum Tier {
        static let blue = UIColor(named: "tierBlue")
        static let green = UIColor(named: "tierGreen")
        static let yellow = UIColor(named: "tierYellow")
        static let gray = UIColor(named: "tierGray")
    }
}

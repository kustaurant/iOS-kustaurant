...
extension EvaluationRatingCell {
    ...
    private func setupLayout() {
        contentView.addSubview(titleLabel, autoLayout: [.leading(20), .top(0), .height(42)])
        contentView.addSubview(starRatingView, autoLayout: [.topNext(to: titleLabel, constant: 6), .leading(20), .width(208), .height(40)])
        contentView.addSubview(starCommentsLabel, autoLayout: [.topNext(to: starRatingView, constant: 6), .fillX(20), .bottom(23)])
    }
}
